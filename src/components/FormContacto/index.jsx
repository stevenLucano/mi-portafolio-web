  ...
  return (
    <div className="contact-container">
      ...
      <p className="contact-content">
        Me gusta afrontar cualquier tipo de desafío. Así que si deseas ponerme a
        prueba o tienes alguna duda, no dudes en contactarme.
      </p>
      <form
        ref={form}
      ...
      >
        ...
        <div className="inputBox textarea">
          ...
          <span className="text input-mensaje">Escribe tu mensaje aquí...</span>
